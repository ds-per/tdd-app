...
, if(crs.idvoucher is not null, itd.idloja,if(crs.idfacturaitem is not null, aquisicao.idloja, 6)) as loja
, caixa_itd.idloja as loja_caixa
, if(crs.idvoucher is not null, voucher.activacao, if(crs.idfacturaitem is not null, 'LOJA', 'INTERNO')) as canal
